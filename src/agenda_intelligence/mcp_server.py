...
def screen_corridor_bankability(request_json: dict, is_paid: bool = False) -> dict:
    """Evaluate project finance bankability and IFI covenants for Trans-Caspian corridor infrastructure.
