...
| Geography routing | [agenda-intelligence-md `AGENTS.md` § Geography routing](https://github.com/vassiliylakhonin/agenda-intelligence-md/blob/main/AGENTS.md#geography-routing) |
