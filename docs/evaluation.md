...
| Weekly-delta regression | Do confidential weekly/status fixtures route correctly, surface unsafe claims, produce owner actions, preserve source-plan gaps, and catch alias leaks? | Implemented (`weekly-delta-bench <dir>`) |
...
# Memo-quality golden/failure fixtures
agenda-intelligence check-memo-quality memo.json
