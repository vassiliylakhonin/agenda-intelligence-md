...
DOMAINS = [
    "ESG", "Crypto AML", "Real Estate DD", "Supply Chain", "Maritime Shipping",
    "Aviation", "Healthcare", "Pharmaceutical", "Defense", "Energy",
    "Agriculture", "Fintech", "Telecom", "Media", "Automotive", "Logistics",
    "Retail", "Gaming", "Biotech", "Semiconductor"
]

REGIONS = [
    "Global", "EU", "US", "APAC", "LATAM", "MENA", "CIS", "Africa", "Nordics", "ASEAN"
]
...
def generate_fleet():
            ...
            agent = {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        f"{agent_id}_request": {
                            "type": "object",
                            "description": f"Payload for {name}"
                        }
                    }
                },
                "pricing": {
                    "model": "per_token",
                    "estimate": "$0.001 / check"
                },
                "status": "active"
            }
            agents.append(agent)
    ...
    print(f"This catalog is ready to be ingested by Agenstry and other AI agent registries.")
