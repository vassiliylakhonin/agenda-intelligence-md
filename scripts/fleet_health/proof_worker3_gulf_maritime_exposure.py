...
def test_rest_sanctioned_vessel():
    ...
    payload = {
        ...
        "voyage": {
            ...
            "origin": "Kharg Island",
            "destination": "Unknown STS Location"
        },
        "exposure_facets": [
            "iran_oil_exposure",
    ...
    assert data.get("triage_recommendation") == "escalate_before_fixture", f"Expected 'escalate_before_fixture', got {data.get('triage_recommendation')}"
    assert any("National Iranian Tanker Company" in d for d in data.get("top_exposure_dimensions", [])), "Expected NITC in top_exposure_dimensions"
    ...
    payload = {
        ...
        "params": {
            ...
            "request": {
                ...
                "counterparties": [
                    {
                        "name": "Copenhagen Tankers Management ApS",
                        "role": "manager",
                        "jurisdiction": "DK"
                    }
                ],
