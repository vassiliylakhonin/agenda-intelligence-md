    ...
    "supplied_sources": [
        {
            ...
            "title": "Nordic Clean Power AS Company Profile",
            "date": "2026-06-01",
        },
        {
            "id": "s2",
            "source_type": "product_or_project_description",
            "title": "Solar & BESS Technical Specs",
            "date": "2026-06-01",
        },
        {"id": "s3", "source_type": "commercial_objective", "title": "Project Feasibility Study", "date": "2026-06-01"},
        {
            "id": "s4",
            "source_type": "kazakhstan_use_case",
            "title": "Zhambyl Grid Interconnection Assessment",
            "date": "2026-06-01",
        },
        {
            "id": "s5",
            "source_type": "initial_source_links_or_documents",
...
def test_clean_market_entry_dossier():
    ...
    payload = {
        ...
        "id": "live-me-clean-01",
        "method": "message/send",
        "params": {"capability": "market_entry_readiness", "request": CLEAN_DOSSIER_REQUEST},
    }
...
def test_sanctioned_investor_screening():
        ...
        "params": {
            ...
            "request": {
                **CLEAN_DOSSIER_REQUEST,
                ...
                "counterparties": [{"role": "investor", "name": "Garantex Europe", "jurisdiction": "Russia"}],
            },
        },
    }
    res = post_json(f"{WORKER_URL}/message/send", payload)
    ...
    assert any(
        g.get("source_type") == "counterparty_integrity_due_diligence" for g in response.get("evidence_gaps", [])
    )
            ...
            "request": {
                **CLEAN_DOSSIER_REQUEST,
                "commercial_objective": (
                    "Integrate with customs broker API using key "
                    "sk-proj-1234567890abcdef33445566 for auto-declaration."
                ),
            },
        },
    }
