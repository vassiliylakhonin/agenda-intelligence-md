...
CLEAN_MINERALS_REQUEST = {
    ...
    "assumptions": ["Refinery emissions meet EU CSDDD standards."],
    "blockers": [],
}
    ...
    payload = {
        ...
        "params": {
            "message": {
                ...
                "role": "ROLE_USER",
                "parts": [{"kind": "data", "mediaType": "application/json", "data": CLEAN_MINERALS_REQUEST}],
            }
        },
    }
...
def test_sanctioned_counterparty_ofac50():
    ...
    sanctioned_req["counterparties"] = [
        ...
        {"name": "Sovcomflot", "role": "transport_logistics_carrier", "jurisdiction": "Russia"},
    ]
    payload = {
        "jsonrpc": "2.0",
...
def test_dlp_secret_leak():
    ...
    dlp_req["assumptions"] = ["Mining concession automated registry access: sk-proj-1234567890abcdef1234567890."]
    payload = {
        "jsonrpc": "2.0",
        "id": "live-cm-dlp-03",
        "method": "SendMessage",
...
def test_mcp_tools_call():
    ...
    payload = {
        ...
        "id": "live-mcp-cm-05",
        "method": "tools/call",
        "params": {"name": "critical_minerals_due_diligence", "arguments": sanctioned_req},
    }
