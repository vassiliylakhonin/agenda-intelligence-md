...
CLEAN_DEAL_REQUEST = {
    ...
    "dated_sources": [
        ...
        },
        {
            ...
            "title": "Carrier vessel voyage schedule",
            "date": "2026-06-01"
        }
    ],
...
def test_clean_middle_corridor_deal():
    ...
    print(f"Decision Readiness: {response.get('decision_readiness_score')}% ({response.get('decision_readiness_label')})")
