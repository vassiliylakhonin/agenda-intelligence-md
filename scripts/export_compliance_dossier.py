...
def generate_markdown(d: Dict[str, Any]) -> str:
    ...
    return f"""# CONFIDENTIAL DEAL DOSSIER — REDACTED AUDIT REPORT
...
* **Mandatory Action:**
  - DO NOT ISSUE OR CONFIRM LETTER OF CREDIT. Demand restructuring of the 34% SDN minority equity link and authenticated End-User Certificate before proceeding.
