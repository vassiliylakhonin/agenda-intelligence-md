...
Multi-surface presentation + deployment automation, plus a new vertical worker (`cis_secondary_sanctions`) and per-profile live retrieval (ADR 0014). The v1.0 request/memo contract surface is unchanged; new schemas under `schemas/v1/` are additive per ADR 0003.
