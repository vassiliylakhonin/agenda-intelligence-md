...
### From GitHub Release (v0.5.3)
```bash
pip install https://github.com/vassiliylakhonin/agenda-intelligence-md/releases/download/v0.5.3/agenda_intelligence_md-0.5.3-py3-none-any.whl
```
