...
- [ ] If geography routing terms changed, updated in `docs/geography-routing.md` and `llms.txt` (sync guarded by `tests/test_product_shell.py::test_routing_terms_documented_in_canon`)
