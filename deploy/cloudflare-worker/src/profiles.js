...
export const BASE_RPC_URL = "https://base-mainnet.public.blastapi.io";
export const BASE_FALLBACK_RPC_URLS = [
...
export const TIER_BANKABILITY_DOSSIER_USDC_AMOUNT = 25;
