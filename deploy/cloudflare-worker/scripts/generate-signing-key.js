...
console.log("  2. For each env you want signed cards on (default + kazakhstan + middle-corridor-deal-risk-gate + cis-secondary-sanctions):");
console.log("     npx wrangler secret put AGENT_CARD_SIGNING_KEY");
console.log("     npx wrangler secret put AGENT_CARD_SIGNING_KEY --env kazakhstan");
...
console.log("  3. npx wrangler deploy && npx wrangler deploy --env kazakhstan && ...");
